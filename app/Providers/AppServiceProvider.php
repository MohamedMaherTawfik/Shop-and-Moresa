...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        // Removed Amirami Localizator service provider registration
    }
    ...
    public function boot(): void
    {
        ...
        if (!App::runningInConsole()) {
            ...
            // Default web config for when database is not ready
            $web_config = [
                'primary_color' => '#007bff',
                'secondary_color' => '#6c757d',
                'primary_color_light' => '#e3f2fd',
                'panel_sidebar_color' => '#343a40',
                'name' => 'Shop and More SA',
                'company_name' => 'Shop and More SA',
                'phone' => '',
                'web_logo' => '',
                'mob_logo' => '',
                'fav_icon' => '',
                ...
                'about' => '',
                'footer_logo' => '',
                'copyright_text' => '© 2024 Shop and More SA. All rights reserved.',
                ...
                'meta_description' => 'Shop and More SA - Your trusted e-commerce platform',
                'cookie_setting' => null,
                'announcement' => null,
            ...
            try {
                if (Schema::hasTable('business_settings')) {
                    ...
                    // Override default config with database values
                    $web_config = array_merge($web_config, [
                ...
                // Log the exception but continue with default config
                \Log::error('AppServiceProvider boot error: ' . $exception->getMessage());
            }

            // Always share the web_config and language variables
