...
public function getRegisterView(): View
{
    ...
    $associations = Association::where('is_active', true)->orderBy('priority')->get(); // ← أضيف
    return view('web-views.customer-views.auth.register', compact('recaptcha', 'associations')); // ← تعديل
}
