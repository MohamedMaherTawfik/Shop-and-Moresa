...
public function signUp(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'con_password.required' => translate('The confirm password field is required.'),
            'con_password.same' => translate('The confirm password and password must match.'),
            'association_id.exists' => translate('The selected association is invalid.')
        ]);
        ...
        try {
            ...
            if ($phoneVerification && !$user->is_phone_verified) {
                return response()->json([
                    'message' => translate('Phone verification required'),
                    'temporary_token' => $temporaryToken,
            ...
            if ($emailVerification && $user->email_verified_at == null) {
                return response()->json([
                    'message' => translate('Email verification required'),
                    'temporary_token' => $temporaryToken,
            ...
            return response()->json([
                'message' => translate('Registration failed'),
                'error' => $e->getMessage()
            ], 500);
        }
    }
