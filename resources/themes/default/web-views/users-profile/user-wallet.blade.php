                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-0 g-md-3 gap-3 h-100">
                            ...
                            <div class="col-md-12">
                                <div class="row  g-3">
                                    @if(!$addFundsToWalletStatus || count($addFundBonusList) <= 0)
                                        <div class="col-12">
                                                ...
                                                <div class="card-body d-flex align-items-center z-2">
                                                    <div
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            @endif
                                                            <button
                                                                class="btn btn-outline-light align-items-center fs-14 font-semi-bold py-2 px-4"
                                                                data-toggle="modal" data-target="#addFundByCoupon">
                                                                <span><i
                                                                        class="tio-ticket text-white"></i></span>
                                                                <span
                                                                    class="text-white">{{ translate('add_fund_by_association_coupon') }}</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <!-- Add Fund by Association Coupon Modal -->
                            <div class="modal fade" id="addFundByCoupon" tabindex="-1"
                                 aria-labelledby="addFundByCouponModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body px-5">
                                            ...
                                            <form action="{{ route('customer.redeem-coupon') }}" method="post">
                                                @csrf
                                                <div class="pb-4">
                                                    <h4 class="text-center">{{ translate('add_fund_by_association_coupon') }}</h4>
                                                    <p class="text-center">{{ translate('enter_your_coupon_code_to_add_fund_to_wallet') }}</p>
                                                    <input type="text"
                                                           class="h-70 form-control text-center text-24 rounded-10 fs-25-important light-placeholder"
                                                           id="coupon-code-input" name="coupon_code"
                                                           required
                                                ...
                                                <div class="d-flex justify-content-center pt-2 pb-3">
                                                    <button type="submit" class="btn btn--primary w-75 mx-3"
                                                            id="redeem_coupon_form_btn">{{ translate('redeem_coupon') }}</button>
                                                </div>
                                                        ...
                                                        <div class="p-3 overflow-auto max-h-290px">
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <div class="d-flex flex-column gap-3 transaction_earn_by">
                                                                    ...
                                                                    <label
                                                                        class="d-flex justify-content-between align-items-center">
                                                                        <span>{{ translate('coupon_redeem') }}</span>
                                                                        <input type="checkbox"
                                                                               class="earn-checkbox border-dark"
                                                                               name="types[]" value="coupon_redeem"
                                                                            {{ in_array('coupon_redeem', $transactionTypes) ? 'checked' : '' }}>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="w-100">
                                                        ...
                                                        <h6 class="text-muted mb-0 small text-capitalize fs-13 font-semibold">
                                                            ...
                                                            @elseif($item['transaction_type'] == 'coupon_redeem')
                                                                {{ translate('coupon_redeem') }}
                                                            @else
