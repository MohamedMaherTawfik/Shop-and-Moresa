                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                            <h5 class="font-bold m-0 fs-16">{{translate('association_coupons')}}</h5>
                                ...
                                <div class="ticket-box">
                                    <div class="ticket-start">
                                        ...
                                        <h2 class="ticket-amount">
                                            {{ webCurrencyConverter(amount: $item->amount) }}
                                        </h2>
                                        <p>
                                    ...
                                    <div class="ticket-end">
                                        ...
                                        <p class="m-0">
                                            {{ translate('status') }}:
                                            <span class="badge badge-{{ $item->status == 'active' ? 'success' : 'danger' }} badge-sm">
