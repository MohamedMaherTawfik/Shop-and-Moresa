...
return [
	...
	"coupon_added_successfully" => "coupon added successfully",
  	"add_fund_by_association_coupon" => "add fund by association coupon",
	"enter_your_coupon_code_to_add_fund_to_wallet" => "enter your coupon code to add fund to wallet",
	...
	"Coupon_not_assigned_to_you" => "Coupon not assigned to you",
	"Coupon_redeemed_successfully" => "Coupon redeemed successfully",
	"Failed_to_redeem_coupon" => "Failed to redeem coupon",
	"An_error_occurred_while_redeeming_coupon" => "An error occurred while redeeming coupon",
