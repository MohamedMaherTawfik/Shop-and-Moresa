    ...
    <div class="aside-body search-aside-attribute-container py-4 pt-0">
        ...
        <ul class="aside-nav navbar-nav gap-2">
            ...
            @if(Helpers::module_permission_check('user_section'))
                            ...
                            <li class="nav-item">
                               ...
                               <li class="nav-item">
                                <a class="nav-link {{ (Request::is('admin/associate-admin/list') || Request::is('admin/employee/add') || Request::is('admin/employee/update*')) ? 'active' : '' }}"
                                   href="/admin/dashboard/associate-admin/list" title="{{ translate('Association Admin') }}">
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/associations*') ? 'active' : '' }}"
                       href="{{ route('admin.associations.index') }}" title="{{ translate('associations') }}">
                ...
                <li>
                    <a class="nav-link {{ Request::is('admin/association-coupons*') ? 'active' : '' }}"
                       href="{{ route('admin.association-coupons.index') }}" title="{{ translate('association_coupons') }}">
