...
Route::group(['namespace' => 'RestAPI\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::controller(CouponController::class)->group(function () {
        ...
        Route::get('association-coupons', 'getAssociationCoupons')->middleware('auth:api');
        Route::post('association-coupons/redeem', 'redeemAssociationCoupon')->middleware('auth:api');
    });
...
Route::post('sign-up', [\App\Http\Controllers\RestAPI\v1\auth\CustomerAPIAuthController::class, 'signUp']);
