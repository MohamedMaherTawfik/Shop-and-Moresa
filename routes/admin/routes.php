...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin', 'actch:admin_panel']], function () {
    ...
    Route::controller(AdvancedSearchController::class)->group(function () {
      ...
      // User management -> Associations 20/10/2025 by abdulrahman nj
    Route::group(['prefix' => 'associations', 'as' => 'associations.'], function () {
        Route::get('', [\App\Http\Controllers\Admin\AssociationController::class, 'index'])->name('index');
        Route::get('create', [\App\Http\Controllers\Admin\AssociationController::class, 'create'])->name('create');
        Route::post('', [\App\Http\Controllers\Admin\AssociationController::class, 'store'])->name('store');
        Route::get('{association}/edit', [\App\Http\Controllers\Admin\AssociationController::class, 'edit'])->name('edit');
        Route::put('{association}', [\App\Http\Controllers\Admin\AssociationController::class, 'update'])->name('update');
        Route::delete('{association}', [\App\Http\Controllers\Admin\AssociationController::class, 'destroy'])->name('destroy');
    });

    // User management -> Association Coupons 21/10/2025 by abdulrahman nj
        Route::group(['prefix' => 'association-coupons', 'as' => 'association-coupons.'], function () {
            Route::get('', [\App\Http\Controllers\Admin\AssociationCouponController::class, 'index'])->name('index');
            Route::get('create', [\App\Http\Controllers\Admin\AssociationCouponController::class, 'create'])->name('create');
            Route::get('get-users', [\App\Http\Controllers\Admin\AssociationCouponController::class, 'getUsers'])->name('get-users');
            Route::post('', [\App\Http\Controllers\Admin\AssociationCouponController::class, 'store'])->name('store');
            Route::post('generate', [\App\Http\Controllers\Admin\AssociationCouponController::class, 'generateForAssociation'])->name('generate');
